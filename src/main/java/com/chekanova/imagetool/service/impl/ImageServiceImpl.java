...
public class ImageServiceImpl implements ImageService {
    ...
    @Override
    public ByteArrayOutputStream compare(MultipartFile file1, MultipartFile file2, String hexColorCode) throws IOException {
        ...
        BufferedImage resultImage = drawDifferenceService.drawDifference(comparisonResult, image1, Color.decode(hexColorCode).getRGB());
