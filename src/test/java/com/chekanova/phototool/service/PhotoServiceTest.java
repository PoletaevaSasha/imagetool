...
import com.chekanova.phototool.service.impl.PhotoServiceImpl;
import com.chekanova.phototool.service.processor.ImageProcessor;
import com.chekanova.phototool.service.processor.impl.AbstractConvolutionProcessor;
...
public class PhotoServiceTest {
    ...
    private PhotoServiceImpl testedObject;
    @Mock
    ...
    @Before
    public void setUp()  {
        testedObject = new PhotoServiceImpl(processingStrategies,imageProcessors);
